---
layout: post
title: "PHP和JavaScript代码规范化工具 + 前端代码规范参考"
...
[![PSR](https://img.shields.io/badge/code%20style-PSR-brightgreen.svg)](https://www.php-fig.org/psr/)


[![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg)](https://standardjs.com)


主要是我有代码洁癖, 比较注重这种规范性的东西, 碰到`for($i=1;$i<$n;$i++){`、`[10,20,30]`、`if($i<$count)`、`function test($a,$b)`、`$_POST['name']==xxx`这种的我肯定受不了. 当然了, 我只是针对事儿, 不针对人.

## PHP代码规范化工具

PHP的规范当然是用[PSR](https://psr.phphub.org)了.

格式化工具推荐: [FriendsOfPHP/PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer)

注意这个东西很卡Atom. 以后再慢慢研究怎么用. 目前好感度不是太高, 先拿来学习代码规范.

## JavaScript代码规范化工具

JavaScript的规范准备用这个[![JavaScript Style Guide](https://cdn.rawgit.com/standard/standard/master/badge.svg)](https://github.com/standard/standard/blob/master/docs/RULES-zhcn.md#javascript-standard-style)


工具: [standard](https://github.com/standard/standard)

`standard`官网: [https://standardjs.com](https://standardjs.com)


## JavaScript代码规范: standard 全文
...
## 前端编码规范: [ecomfe/spec](https://github.com/ecomfe/spec)

哪里感觉迷就补哪里. 好像是来自百度的. 作为参考.
...
这个项目有不少其他语言的. 不过这个项目的更新时间有些久远. 在现在来看是 2017 年 9 月更的.